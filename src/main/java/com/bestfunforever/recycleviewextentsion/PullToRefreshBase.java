 ...
 *******************************************************************************/
package com.bestfunforever.recycleviewextentsion;
...
import com.bestfunforever.recycleviewextentsion.internal.BaseLoadingLayout;
import com.bestfunforever.recycleviewextentsion.internal.Utils;
import com.bestfunforever.recycleviewextentsion.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout{
		...
		switch (action) {
			case MotionEvent.ACTION_MOVE: {
				...
				if (isReadyForPull()) {
					...
					Log.d("","check move intercept mIsBeingDragged "+mIsBeingDragged);
				}
				break;
			}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mHeaderLayout = createHeaderLoadingLayout(context, Mode.PULL_FROM_START, a);
	...
	protected abstract BaseLoadingLayout createFooterLoadingLayout(Context context, Mode pullFromEnd, TypedArray a);

	protected abstract BaseLoadingLayout createHeaderLoadingLayout(Context context, Mode pullFromStart, TypedArray a);
	...
	private void pullEvent() {
		...
		Log.d("","pullEvent newScrollValue "+newScrollValue+" isRefreshing "+isRefreshing());
		...
		if (newScrollValue != 0 && !isRefreshing()) {
			...
			Log.d("","pullEvent newScrollValue "+newScrollValue+" itemDimension "+itemDimension);
